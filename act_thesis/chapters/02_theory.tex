...
\begin{figure}[htbp]
    ...
    \caption{Simulation \footnote{Disclaimer: Simulation created with the help of AI (see appendix \ref{sec:ai})} of the $J$ state distribution, under an electromagnetic field with $320\, \mathrm{ps}$ FWHM Gaussian envelope and $10^{12}\,\mathrm{W}/\mathrm{cm}^2$ maximum intensity.}
