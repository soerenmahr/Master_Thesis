...
\end{equation}
the first two terms form a non-rotating background, and only the cross term carries the rotating linear polarization. With the real Gaussian amplitudes $A_j(t,z_j)$ \eqnref{eq:gaussian_envelope} and temporal phase $\Phi_j(t,z_j)$ \ref{eq:time_phase} it reads
\begin{equation}
