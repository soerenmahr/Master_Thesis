...
\begin{table}[htbp]
  ...
  \begin{tabular}{|*{12}{c|}}
    ...
    \multicolumn{4}{P{\espanIV}|}{%
      \pcell{Environment}{\dots}} \\
    \hline\noalign{\vskip 2pt}
    % --- VMI / MCP voltages (halves) ---
    \multicolumn{6}{|P{\espanVI}|}{%
      \pcell{$V_\mathrm{VMI}$}{\dots}} &
    \multicolumn{6}{P{\espanVI}|}{%
      \pcell{$V_\mathrm{MCP}$}{\dots}} \\
    \hline\noalign{\vskip 2pt}
    % --- Trigger rescaling / MCP-Delay / Camera-Delay (thirds) ---
    \multicolumn{4}{|P{\espanIV}|}{%
      \pcell{Trigger rescaling}{\dots}} &
    \multicolumn{4}{P{\espanIV}|}{%
      \pcell{MCP-Delay}{\dots}} &
    \multicolumn{4}{P{\espanIV}|}{%
      \pcell{Camera-Delay}{\dots}} \\
    ...
    \multicolumn{4}{|P{\espanIV}|}{%
      \pcell{Center}{$(194,\,204)\,$px}} &
    \multicolumn{4}{P{\espanIV}|}{%
      \pcell{Angle}{$12^\circ$}} &
    \multicolumn{4}{P{\espanIV}|}{%
      \pcell{Radial gate}{$[60,\,120]\,$px}} \\
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    % --- Delay-Center / Transform parameter (halves) ---
    \multicolumn{6}{|P{\espanVI}|}{%
      \pcell{Delay-Center}{$85.55\,$mm}} &
    \multicolumn{6}{P{\espanVI}|}{%
      \pcell{Transform parameter}{0.79}} \\
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
