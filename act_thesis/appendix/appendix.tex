...
\begin{longtable}{|*{12}{c|}}
  ...
  \multicolumn{4}{|P{\espanIV}|}{%
    \pcell{Molecule}{\CSS}} &
  \multicolumn{4}{P{\espanIV}|}{%
    \pcell{Centrifuge $f_\mathrm{FWHM}$}{\dots}} &
  \multicolumn{4}{P{\espanIV}|}{%
  ...
  \endlastfoot
    ...
    \rowcolor{repeatbg}
    \multicolumn{6}{|P{\espanVI}|}{%
      \pcell{Camera Setting}{\dots}} &
    \multicolumn{6}{P{\espanVI}|}{%
      \pcell{Ions/Frame}{\dots}} \\*
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    \multicolumn{3}{|P{\espanIII}|}{%
      \pcell{$p_\mathrm{Source}$}{\dots}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Doping}$}{\dots}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Differential}$}{\dots}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Detection}$}{\dots}} \\
    % ==== end repeated block ==================================
    % ==== next scan: copy of the block above ==================
    \hline\hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
