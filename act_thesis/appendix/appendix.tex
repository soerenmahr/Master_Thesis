...
\begin{table}[htbp]
  \centering
  \caption{Centrifuge setting: Highest accelerating centrifuge with starting frequency at around \SI{0}{\giga \hertz} - to capture the molecules from their ground state.}
  \label{tab:centrifuge-high_acceleration}
  \singlespacing
  \begin{tabular}{|*{12}{c|}}
    \hline\noalign{\vskip 2pt}
    % --- Description (full width) ---
    \multicolumn{12}{|P{\espanXII}|}{%
      \pcell{Description}{Fast accelerating centrifuge starting at \SI{0}{\giga \hertz}}} \\
    \hline\noalign{\vskip 2pt}
    % --- Grating arm / Delay arm position (halves) ---
    \multicolumn{6}{|P{\espanVI}|}{%
      \pcell{Grating arm position}{\SI{26}{\milli \meter}}} &
    \multicolumn{6}{P{\espanVI}|}{%
      \pcell{Delay arm position}{\SI{15.9}{\milli \meter}}} \\
    \hline\noalign{\vskip 2pt}
    % --- Expected f_FWHM / Central frequency (halves) ---
    \multicolumn{6}{|P{\espanVI}|}{%
      \pcell{Expected $2f_\mathrm{FWHM}$}{\SIrange{10}{90}{\giga \hertz}}} &
    \multicolumn{6}{P{\espanVI}|}{%
      \pcell{Central frequency}{\SI{50}{\giga \hertz}}} \\
    \hline
  \end{tabular}
\end{table}
...
\begin{longtable}{|*{12}{c|}}
  \caption{Experimental parameters for \CSS being accelerated in the helium droplets. }
  \label{tab:experimental-params}\\
  \hline\noalign{\vskip 2pt}
  % --- Title (full width) ---
  \multicolumn{12}{|P{\espanXII}|}{%
    \pcell{Title}{Accelerating \CSS in the superfluid}} \\*
  \hline\noalign{\vskip 2pt}
  % --- Molecule / Centrifuge / Environment (thirds) ---
  \multicolumn{4}{|P{\espanIV}|}{%
    \pcell{Molecule}{\CSS}} &
  \multicolumn{4}{P{\espanIV}|}{%
    \pcell{Centrifuge}{\tabref{tab:centrifuge-high_acceleration}}} &
  \multicolumn{4}{P{\espanIV}|}{%
    \pcell{Environment}{Droplets - \SI{30}{\bar}/\SI{16}{\kelvin}}} \\*
  \hline\noalign{\vskip 2pt}
  % --- Pulse Power (halves) ---
  \multicolumn{6}{|P{\espanVI}|}{%
    \pcell{Centrifuge energy}{\SI{3}{\milli \joule}}} &
  \multicolumn{6}{P{\espanVI}|}{%
    \pcell{Probe energy}{\SI{650}{\micro \joule}}} \\*
  \hline\noalign{\vskip 2pt}
  % --- VMI / MCP voltages (halves) ---
  \multicolumn{6}{|P{\espanVI}|}{%
    \pcell{$V_\mathrm{Repeller/ Extractor}$}{\SI{6}{\kilo \volt}/ \SI{3.9}{\kilo \volt}}} &
  \multicolumn{6}{P{\espanVI}|}{%
    \pcell{$V_\mathrm{Phosphor/ MCP}$}{\SI{4}{\kilo \volt}/ \SI{1.05}{\kilo \volt}}} \\*
  \hline\noalign{\vskip 2pt}
  % --- Trigger rescaling / MCP-Delay / Camera-Delay (thirds) ---
  \multicolumn{4}{|P{\espanIV}|}{%
    \pcell{Trigger rescaling}{1}} &
  \multicolumn{4}{P{\espanIV}|}{%
    \pcell{MCP-Delay}{\SI{3747}{\nano \second}/ \SI{60}{\nano \second}}} &
  \multicolumn{4}{P{\espanIV}|}{%
    \pcell{Camera-Delay}{\SI{0.8}{\milli \second}/ \SI{0.1}{\milli \second}}} \\
  \endfirsthead
  % ---- repeated on every page after the first --------------
  \multicolumn{12}{|P{\espanXII}|}{\textit{Table \thetable{} -- continued from previous page}} \\
  \hline
  \endhead
  % ---- repeated at the bottom of every page but the last ---m \s
  \hline
  \multicolumn{12}{|P{\espanXII}|}{\hfill\textit{continued on next page}} \\
  \endfoot
  % ---- shown once, at the very end of the table -------------
  \hline
  \endlastfoot
    % ==== repeat this block once per scan ====================
    \hline\hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    % --- Scan Name (full width) ---
    \multicolumn{12}{|P{\espanXII}|}{%
      \pcell{Scan Name}{20251212/Scan4}} \\*
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    % --- Center / Angle / Radial gate (thirds) ---
    \multicolumn{4}{|P{\espanIV}|}{%
      \pcell{Center}{(\num{194}, \num{204})\,\si{\pixel}}} &
    \multicolumn{4}{P{\espanIV}|}{%
      \pcell{Angle}{\SI{12}{\degree}}} &
    \multicolumn{4}{P{\espanIV}|}{%
      \pcell{Radial gate}{\SIrange{60}{120}{\pixel}}} \\*
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    % --- Delay-Center / Transform parameter (halves) ---
    \multicolumn{6}{|P{\espanVI}|}{%.
      \pcell{Delay-Center}{\SI{85.55}{\milli\meter}}} &
    \multicolumn{6}{P{\espanVI}|}{%
      \pcell{Transform parameter}{\num{0.79}}} \\*
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    % --- Camera Setting / Ions per Frame range (halves) ---
    \multicolumn{6}{|P{\espanVI}|}{%
      \pcell{Camera Setting}{\SI{25}{\decibel}, \SI{10}{\milli \second} untriggered}} &
    \multicolumn{6}{P{\espanVI}|}{%
      \pcell{Ions/Frame}{\SI{2}{\ipf}}} \\*
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    % --- Source / Doping / Differential / Detection pressures (quarters) ---
    \multicolumn{3}{|P{\espanIII}|}{%
      \pcell{$p_\mathrm{Source}$}{-}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Doping}$}{-}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Differential}$}{-}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Detection}$}{\SI{3.92e-9}{\torr}}} \\
    % ==== end repeated block ==================================
    % ==== next scan: copy of the block above ==================
    \hline\hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    \multicolumn{12}{|P{\espanXII}|}{%
      \pcell{Scan Name}{20251213/Scan1}} \\*
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    \multicolumn{4}{|P{\espanIV}|}{%
      \pcell{Center}{(\num{194}, \num{204})\,\si{\pixel}}} &
    ...
    \rowcolor{repeatbg}
    \multicolumn{3}{|P{\espanIII}|}{%
      \pcell{$p_\mathrm{Source}$}{\SI{6.27e-5}{\torr}}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Doping}$}{\SI{3.58e-7}{\torr}}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Differential}$}{\SI{1.89e-8}{\torr}}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Detection}$}{\SI{4.03e-9}{\torr}}} \\
    % ==== end repeated block ==================================
    % ==== next scan: copy of the block above ==================
    \hline\hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    \multicolumn{12}{|P{\espanXII}|}{%
      \pcell{Scan Name}{20251213/Scan2}} \\*
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    \multicolumn{4}{|P{\espanIV}|}{%
      \pcell{Center}{(\num{194}, \num{204})\,\si{\pixel}}} &
    ...
    \rowcolor{repeatbg}
    \multicolumn{3}{|P{\espanIII}|}{%
      \pcell{$p_\mathrm{Source}$}{\SI{6.5e-5}{\torr}}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Doping}$}{\SI{3.5e-7}{\torr}}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Differential}$}{\SI{1.86e-8}{\torr}}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Detection}$}{\SI{3.95e-9}{\torr}}} \\
    % ==== end repeated block ==================================
    % ==== next scan: copy of the block above ==================
    \hline\hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    \multicolumn{12}{|P{\espanXII}|}{%
      \pcell{Scan Name}{20251213/Scan3}} \\*
    \hline\noalign{\vskip 2pt}
    \rowcolor{repeatbg}
    \multicolumn{4}{|P{\espanIV}|}{%
      \pcell{Center}{(\num{194}, \num{204})\,\si{\pixel}}} &
    ...
    \rowcolor{repeatbg}
    \multicolumn{3}{|P{\espanIII}|}{%
      \pcell{$p_\mathrm{Source}$}{\SI{6.81e-5}{\torr}}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Doping}$}{\SI{3.54e-7}{\torr}}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Differential}$}{\SI{1.85e-8}{\torr}}} &
    \multicolumn{3}{P{\espanIII}|}{%
      \pcell{$p_\mathrm{Detection}$}{\SI{3.96e-9}{\torr}}} \\
    % ==== end repeated block ==================================
\end{longtable}
\endgroup
